...
namespace Attendance_System___ITI.Controllers
{
    ...
    public class AnnouncementsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Descreption")] Announcement announcement)
        {
                announcement.Date = DateTime.Now.ToString("MMMM dd");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descreption,Date")] Announcement announcement)
        {
